        ...
        <body>
            ...
            <div class="content-admin">
                ...
                <div class="d-flex" style="margin-top: 20px">
                    ...
                    <form action="{{ url('tbbarang') }}" method="POST">
                        @csrf
                    <table style="margin-left: 50px; font-size: 20px">
                        ...
                        <tr>
                            ...
                            <td style="padding: 15px 10px 15px 10px"><input type="text" class="search" placeholder="Inputkan Id Barang" name="id" id="id"></td>
                        </tr>
                        <tr>
                            <td style="padding-left:15px">Nama Barang</td>
                            <td style="padding: 5px 10px 5px 10px">:</td>
                            <td style="padding: 15px 10px 15px 10px"><input type="text" class="search" placeholder="Inputkan Nama Barang" name="namabarang" id="namabarang"></td>
                        </tr>
                        <tr>
                            <td style="padding-left:15px">Stock</td>
                            <td style="padding: 5px 10px 5px 10px">:</td>
                            <td style="padding: 15px 10px 15px 10px"><input type="number" class="search" placeholder="Inputkan Stock Barang" name="stock" id="stock"></td>
                        </tr>
                        <tr>
