    ...
    <head>
        ...
        <body>
            ...
            <div class="content-admin">
                <h1 style="font-weight: bold; color:#FFC600">Tambah</h1>  
                <div class="d-flex" style="margin-top: 20px">
                    <div>
                    <img src="image/gambar.png" width="450px" alt="">
                </div>
                    <form action="{{ url('tbuser') }}" method="POST">
                        @csrf
                    <table style="margin-left: 50px; font-size: 20px">
                        ...
                        <tr>
                            ...
                            <td style="padding: 15px 10px 15px 10px"><input type="text" class="search" placeholder="Inputkan NIS User" name="id" id="id"></td>
                        </tr>
                        <tr>
                            <td style="padding-left:15px">Nama</td>
                            <td style="padding: 5px 10px 5px 10px">:</td>
                            <td style="padding: 15px 10px 15px 10px"><input type="text" class="search" placeholder="Inputkan Nama User" name="nama" id="nama"></td>
                        </tr>
                        <tr>
                            <td style="padding-left:15px">Email</td>
                            <td style="padding: 5px 10px 5px 10px">:</td>
                            <td style="padding: 15px 10px 15px 10px"><input type="text" class="search" placeholder="Inputkan Email User" name="email" id="email"></td>
                        </tr>
                        <tr>
                            <td style="padding-left:15px">Password</td>
                            <td style="padding: 5px 10px 5px 10px">:</td>
                            <td style="padding: 15px 10px 15px 10px"><input type="text" class="search" placeholder="Inputkan Password User" name="password" id="password"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><Button type="submit" class="btn-addk">Tambah</Button></td>
                        </tr>
                    </table>
                </form>
                </div>
